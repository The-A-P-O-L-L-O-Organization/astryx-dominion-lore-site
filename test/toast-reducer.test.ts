...
const baseToast = { id: '1', title: 'Test', description: 'Desc', open: true, onOpenChange: () => {} }
...
describe('reducer', () => {
  ...
  it('UPDATE_TOAST updates existing toast', () => {
    const state = { toasts: [baseToast] }
    const next = reducer(state, { type: 'UPDATE_TOAST', toast: { id: '1', title: 'Updated', open: true, onOpenChange: () => {} } })
